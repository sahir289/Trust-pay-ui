import {
  ...
  const BankDetailsModal: React.FC<ModalProps> = ({ handleModal, transaction }) => {
    return (
      <Dialog open={true} onClose={handleModal}>
        <Dialog.Panel>
          <Dialog.Title>
            <h2 className="mr-auto text-base font-medium">Bank Account Details</h2>
            <Lucide
              icon="X"
          ...
          <div className="col-span-12 sm:col-span-6 mx-5 mt-2">
            ...
            <FormInput id="account-name" type="text" placeholder={transaction.accountName} />
          </div>
          ...
          <Dialog.Description className="grid grid-cols-2 gap-4 gap-y-3">
            ...
            <div className="col-span-1">
              ...
              <FormInput id="bank-details" type="text" placeholder={transaction.bankDetails} />
            </div>
  
            {/* Account Number */}
            <div className="col-span-1">
              <FormLabel htmlFor="account-number">Account Number</FormLabel>
              <FormInput id="account-number" type="text" placeholder={transaction.accountNumber} />
            </div>
  
            {/* UPI ID */}
            <div className="col-span-1">
              <FormLabel htmlFor="upi-id">UPI ID</FormLabel>
              <FormInput id="upi-id" type="text" placeholder={transaction.upiId} />
            </div>
  
            {/* Balance */}
            <div className="col-span-1">
              <FormLabel htmlFor="balance">Balance</FormLabel>
              <FormInput id="balance" type="text" placeholder={transaction.balance} />
            </div>
  
            {/* Status */}
            <div className="col-span-1 sm:col-span-1">
              <FormLabel htmlFor="status">Status</FormLabel>
              <FormInput id="status" type="text" placeholder={transaction.status} />
            </div>
  
            {/* Bank Used For */}
            <div className="col-span-1 sm:col-span-1">
              <FormLabel htmlFor="bank-used-for">Bank Used For</FormLabel>
              <FormInput id="bank-used-for" type="text" placeholder={transaction.bankUsedFor} />
            </div>
  
            {/* Vendors */}
            <div className="col-span-1 sm:col-span-1">
              <FormLabel htmlFor="vendors">Vendors</FormLabel>
              <FormInput id="vendors" type="text" placeholder={transaction.vendors} />
            </div>
  
            {/* Created At */}
            <div className="col-span-1 sm:col-span-1">
              <FormLabel htmlFor="created-at">Created At</FormLabel>
              <FormInput id="created-at" type="text" placeholder={transaction.createdAt} />
            </div>
  
            {/* Last Scheduled At */}
            <div className="col-span-1 sm:col-span-1">
              <FormLabel htmlFor="last-scheduled-at">Last Scheduled At</FormLabel>
              <FormInput id="last-scheduled-at" type="text" placeholder={transaction.lastScheduledAt} />
            </div>
          </Dialog.Description>
