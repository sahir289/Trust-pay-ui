      ...
      <div className="col-span-12">
        <div className="mt-3.5">
          <div className="flex flex-col">
            ...
            <CustomTable columns={theadData} data={payins} title={"Payins"} status={["Dropped","Failed"]}/>
            {/* <Table className="border-b border-slate-200/60">
                ...
                <Table.Tbody>
                  {_.take(
                    _.orderBy(
                      _.filter(payins.fakePayins(), (o) => _.includes(['Dropped', 'Failed'], o.status)),
                      ['sno'],
                      ['desc']
                    ),
                    10
