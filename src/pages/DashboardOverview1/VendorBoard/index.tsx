...
function VendorBoard() {
  ...
  const currentBalance = totalPayIns - totalPayOuts - (totalCommission) + totalSettlements + totalReversePayOuts - totalChargeBacks;
  const netBalance = totalPayIns - totalPayOuts - (totalCommission) + totalSettlements + totalReversePayOuts - totalChargeBacks;
